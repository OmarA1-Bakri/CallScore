...
writeJson("media-task-envelope-schema.json", { schema: "callscore.media_task_envelope.v1.schema", required: ["schema", "task_id", "workflow_id", "parent_agent_id", "target_agent_id", "channel", "media_type", "objective", "source_artifact_refs", "source_evidence_refs", "copy_context_refs", "visual_brief_ref", "platform_constraints", "required_tools", "granted_tools", "forbidden_tools", "output_schema", "execution_mode", "design_bundle_path", "frontend_design_skill_path", "required_skills", "required_receipts", "content_reference_mode", "mutation_allowed"] });
writeJson("media-tool-inheritance-receipt-schema.json", { schema: "callscore.media_tool_inheritance_receipt.v1.schema", required: ["schema", "task_id", "parent_agent_id", "media_agent_id", "workflow_id", "channel", "media_type", "requested_tools", "granted_tools", "denied_tools", "tool_versions", "execution_mode", "may_write_artifact_files", "provider_public_mutation_allowed", "frontend_design_granted", "design_bundle_read_access_granted", "parent_harness_render_tools_granted", "created_at_utc"] });
writeJson("media-artifact-receipt-schema.json", { schema: "callscore.media_artifact_receipt.v2.schema", required: ["schema", "artifact_id", "media_artifact_id", "created_by_agent_id", "channel_head_agent_id", "workflow_id", "media_type", "source_copy_artifact_id", "source_visual_brief_id", "source_evidence_paths", "tool_inheritance_receipt_id", "tools_used", "renderer_used", "input_spec_path", "output_paths", "mime_type", "dimensions", "duration_seconds", "file_size_bytes", "sha256", "alt_text", "visual_qa_receipt_id", "copy_visual_coherence_receipt_id", "design_bundle_reference_receipt", "website_design_alignment_receipt", "branding_receipt", "brand_lockup_occlusion_check", "hardcoded_runtime_media", "parent_harness_rendered", "status"] });
