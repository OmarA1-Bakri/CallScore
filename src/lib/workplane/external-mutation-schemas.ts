...
export const ExternalMutationBlockerCodeSchema = z.enum([
  ...
  "non_graph_credential_rotation_blocked",
  "credential_rotation_provider_tool_missing",
  "credential_rotation_phase_missing",
  "credential_rotation_secret_sink_unavailable",
  "credential_rotation_revoke_tool_invalid",
  "replacement_readback_receipt_missing",
  "replacement_readback_receipt_unreadable",
  "replacement_readback_receipt_hash_mismatch",
  "replacement_readback_receipt_invalid",
  "replacement_readback_receipt_stale",
  "secret_gate_receipt_missing",
  "secret_gate_receipt_unreadable",
  "secret_gate_receipt_invalid",
  "secret_gate_receipt_hash_mismatch",
  "secret_gate_receipt_expired",
  "secret_gate_receipt_binding_mismatch",
  "provider_execution_receipt_evidence_missing",
  "provider_execution_receipt_evidence_unreadable",
  "provider_execution_receipt_evidence_hash_mismatch",
  "provider_execution_receipt_evidence_invalid",
]);
