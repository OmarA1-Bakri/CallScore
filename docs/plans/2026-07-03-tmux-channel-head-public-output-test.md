...
- community@call-score.com — newsletters, community broadcasts, and broad community communications; not outbound human outreach.
...
- The email workflow must not use `community@call-score.com` or `noreply@call-score.com` for outreach/persona sends or outreach drafts; community is reserved for newsletters/community broadcasts, and noreply is reserved for customer-service/system no-reply flows.
